...
my_scores <- score_WIS(forecast_data = forecast_paths, truth=my_truth, ingest = "list", missing = "remove") 

#Example using ingest=path
#my_dir = "C:/Users/unp7/Desktop/Misc/test_CovidCAR/2021-08-23-CovidCAR-run2023-05-20/forecasts"
#my_scores = score_WIS(forecast_data = my_dir, truth=my_truth, ingest = "path") 
